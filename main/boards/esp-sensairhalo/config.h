...
#define LCD_TP_SCL                      BOARD_I2C_SCL
#define LCD_TP_SDA                      BOARD_I2C_SDA
...
#define CAMERA_SPI_PORT                 1
#define CAMERA_SPI_CS_PIN               GPIO_NUM_27
#define CAMERA_SPI_SCLK_PIN             GPIO_NUM_25
#define CAMERA_SPI_DATA0_PIN            GPIO_NUM_23
#define CAMERA_XCLK_PIN                 GPIO_NUM_24
