...
class RainmakerLightController : public ILightController {
private:
...
public:
    RainmakerLightController();
    virtual ~RainmakerLightController() = default;
    ...
    void OnRainmakerStateChange(bool power, int hue, int brightness);
    
private:
    void SyncToRainmaker();
    void SyncFromRainmaker();
